...
TWS_PRIVATE_INLINE tws_Atomic _AtomicInc_Rel(NativeAtomic *x) { return atomic_fetch_add_explicit(&x->val, 1, memory_order_release) + 1; }
TWS_PRIVATE_INLINE tws_Atomic _AtomicDec_Acq(NativeAtomic *x) { return atomic_fetch_add_explicit(&x->val, -1, memory_order_acquire) - 1; }
...
TWS_PRIVATE_INLINE int _AtomicCAS_Rel(NativeAtomic *x, tws_Atomic *expected, tws_Atomic newval) { return atomic_compare_exchange_strong_explicit(&x->val, expected, newval, memory_order_release, memory_order_consume); }
...
TWS_PRIVATE_INLINE tws_Atomic _AtomicGet_Seq(const NativeAtomic *x) { return atomic_load_explicit((volatile atomic_int*)&x->val, memory_order_seq_cst); }
TWS_PRIVATE_INLINE tws_Atomic _AtomicGet_Acq(const NativeAtomic *x) { return atomic_load_explicit((volatile atomic_int*)&x->val, memory_order_acquire); }
//TWS_PRIVATE_INLINE tws_Atomic _AtomicGet_Rel(const NativeAtomic *x) { return atomic_load_explicit((volatile atomic_int*)&x->val, memory_order_release); }
...
/*
TWS_PRIVATE_INLINE int _Atomic64CAS_Seq(NativeAtomic64 *x, tws_Atomic64 *expected, tws_Atomic64 newval) { return atomic_compare_exchange_strong(&x->val, expected, newval); }
TWS_PRIVATE_INLINE void _Atomic64Set_Seq(NativeAtomic64 *x, tws_Atomic64 newval) { atomic_store(&x->val, newval); }
TWS_PRIVATE_INLINE tws_Atomic64 _Relaxed64Get(const NativeAtomic64 *x) { COMPILER_BARRIER(); return atomic_load_explicit((volatile atomic_int_least64_t*)&x->val, memory_order_relaxed); }
*/

//TWS_PRIVATE_INLINE int _AtomicPtrCAS_Weak(AtomicPtrPtr x, void **expected, void *newval) { return atomic_compare_exchange_weak(x, expected, newval); }

TWS_PRIVATE_INLINE void _Mfence() { COMPILER_BARRIER(); atomic_thread_fence(memory_order_seq_cst); }
...
TWS_PRIVATE_INLINE tws_Atomic _AtomicInc_Rel(NativeAtomic *x) { return _InterlockedIncrement(&x->val); }
TWS_PRIVATE_INLINE tws_Atomic _AtomicDec_Acq(NativeAtomic *x) { return _InterlockedDecrement(&x->val); }
...
TWS_PRIVATE_INLINE int _AtomicCAS_Rel(NativeAtomic *x, tws_Atomic *expected, tws_Atomic newval) { return _msvc_cas32_x86(x, expected, newval); }
...
TWS_PRIVATE_INLINE tws_Atomic _AtomicGet_Seq(const NativeAtomic *x) { COMPILER_BARRIER(); return x->val; }
TWS_PRIVATE_INLINE tws_Atomic _AtomicGet_Acq(const NativeAtomic *x) { COMPILER_BARRIER(); return x->val; }
TWS_PRIVATE_INLINE tws_Atomic _AtomicGet_Rel(const NativeAtomic *x) { COMPILER_BARRIER(); return x->val; }
...
//TWS_PRIVATE_INLINE int _AtomicPtrCAS_Weak(AtomicPtrPtr x, void **expected, void *newval) { return _msvc_casptr_x86(x, expected, newval); }

TWS_PRIVATE_INLINE void _Mfence(void) { COMPILER_BARRIER(); _mm_mfence(); }
...
TWS_PRIVATE_INLINE tws_Atomic _AtomicInc_Rel(NativeAtomic* x) { return __sync_add_and_fetch(&x->val, 1); }
TWS_PRIVATE_INLINE tws_Atomic _AtomicDec_Acq(NativeAtomic* x) { return __sync_sub_and_fetch(&x->val, 1); }
TWS_PRIVATE_INLINE tws_Atomic _AtomicDec_Rel(NativeAtomic* x) { return __sync_sub_and_fetch(&x->val, 1); }
TWS_PRIVATE_INLINE int _AtomicCAS_Rel(NativeAtomic* x, tws_Atomic* expected, tws_Atomic newval) { return _sync_cas32(&x->val, expected, newval); }
...
TWS_PRIVATE_INLINE tws_Atomic _AtomicGet_Seq(const NativeAtomic* x) { return __sync_add_and_fetch(&((NativeAtomic*)x)->val, 0); }
TWS_PRIVATE_INLINE tws_Atomic _AtomicGet_Acq(const NativeAtomic* x) { return __sync_add_and_fetch(&((NativeAtomic*)x)->val, 0); }
TWS_PRIVATE_INLINE tws_Atomic _AtomicGet_Rel(const NativeAtomic* x) { return __sync_add_and_fetch(&((NativeAtomic*)x)->val, 0); }
TWS_PRIVATE_INLINE tws_Atomic _RelaxedGet(const NativeAtomic* x) { return x->val; }
...
TWS_PRIVATE_INLINE void _Mfence() { COMPILER_BARRIER(); __sync_synchronize(); }
