...
TIO_EXPORT void tio_memstream(tio_Stream *sm, const void *mem, size_t memsize, tio_StreamFlags flags, size_t blocksize)
{
    checknotnull_err(sm);
    initmemstream(sm, mem, memsize, flags, blocksize);
}
